...
path_to_buffers = Path(ROOT_DIR) / "logs" / "double_integrator" / \
    "07-19-23_16.25.39_DRPO_219803" / "test-2023-07-20-15-49-09-offline" / \
    "real_buffer-expert.h5py"
...
if __name__ == '__main__':
    ...
    new_data["h"] = data["constraint_values"].max(dim=1).values
    ...
    ## 3: save new buffer
    new_buffer.save_h5py(path_to_buffers.parent / "di-expert-50k.h5py")