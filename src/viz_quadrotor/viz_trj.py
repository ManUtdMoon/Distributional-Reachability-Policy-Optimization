...
ALG2CMAP = dict([('DRPO', (0.0, 0.24705882352941178, 1.0)),
                 ('SAC-L', (0.011764705882352941, 0.9294117647058824, 0.22745098039215686)),
                 ('SMBPO', (0.9098039215686274, 0.0, 0.043137254901960784)),
                 ('MBPO', (0.5411764705882353, 0.16862745098039217, 0.8862745098039215)),
                 ('CSC', (1.0, 0.7686274509803922, 0.0))])
...
if __name__ == '__main__':
    ...
    trj_MBPO = plt_trajectory(
        ax, 'DRPO',
        LOGS_DIR / 'Comparison' / 'DRPO' / '08-30-22_03.22.29_drpo_219803' / 'test-2022-10-19-10-30-20'
    )
